...
public class FullHealth implements IPillEffect {
    ...
    public IPillEffect redirect(ServerPlayer player) {
        return PlayerHelper.getPillQuality(player) < 0 ? ModPillEffect.BAD_TRIP.get() : this;
    }
    ...
    public void makeSound(ServerPlayer player) {
        player.playNotifySound(ModSounds.FULL_HEALTH.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
        player.playNotifySound(ModSounds.PILL_USE_GOOD_WITH_EFFECT.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
    }

    @Override
    public void makeSoundH(ServerPlayer player) {
        player.playNotifySound(ModSounds.FULL_HEALTH_H.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
    ...
    public String getDescriptionId(int pillQuality){
        return pillQuality < 0
                ...
                : "pill.isaac_disaster.effect.full_health";
    }
