...
public class TheHangedMan extends TarotAbility {
    private static final CompositeTrigger TRIGGER = new CompositeTrigger(List.of(
            new SimpleTrigger(ModTriggerTypes.EMTPY, ModExecutableEffects.THE_HANGED_MAN)
    ));
    ...
    public void makeSound(ServerPlayer player) {
        ...
        player.playNotifySound(ModSounds.THE_HANGED_MAN.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
    }
