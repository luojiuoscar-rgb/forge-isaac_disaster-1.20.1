...
public class CancerTrinket extends TrinketAbility {
    public CancerTrinket(int id, int level) {
        super(id, level);
    }
    ...
    public List<Component> getSynergyDesc(@Nullable ItemStack stack) {
        return (stack != null && Trinket.isEnchanted(stack))
                ? List.of(Component.translatable("item.isaac_disaster.synergy.description.double")
