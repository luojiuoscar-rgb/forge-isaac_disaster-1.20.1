...
public class Breakfast extends PassiveAbility {

    public Breakfast(int id, int level) {
        super(id, level);
    }
    ...
    public List<Component> getSynergyDesc(@Nullable ItemStack stack) {
        ...
        if (ClientDataManager.getInstance().getCountFromId(ItemId.BINGE_EATER.getId()) > 0){
            ...
            description.add(StatManager.BULLET_SPEED.description(1, Style.EMPTY.withColor(ColorManager.SYNERGY)));
