...
public class TwoOfSpades extends PickupAbility {
    private static final CompositeTrigger TRIGGER = new CompositeTrigger(List.of(
            new SimpleTrigger(ModTriggerTypes.EMTPY, ModExecutableEffects.TWO_OF_SPADES)
    ));
    ...
    public void makeSound(ServerPlayer player) {
        ...
        player.playNotifySound(ModSounds.TWO_OF_SPADES.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
    }
