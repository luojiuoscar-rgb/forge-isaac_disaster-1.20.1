...
public class CursedPenny extends TrinketAbility {
    public CursedPenny(int id, int level) {
        super(id, level);
    }
    ...
    public void onEquipped(LivingEntity entity, TrinketAbilityContext ctx) {
        StatManager.addTriggerModule(entity, ModTriggerModule.CURSED_PENNY.getId(), 1);
    }
    ...
    public List<Component> getDesc(@Nullable ItemStack stack) {
        return List.of(
                Component.translatable("item.isaac_disaster.cursed_penny.lore.1")
        );
    }
