                ...
                playerItemUseRecord -> {
                    ...
                    for (int i = 0; i < 3; i++) {
                        ...
                        if (card == null || (pe != null && pe.sequence() >= card.sequence())) {
                            ...
                            if (pe.isHorse()){
                                PillEffectManager.getInstance().getEffectFromEffectId(pe.id()).onUseH(serverPlayer);
                            }else{
                                PillEffectManager.getInstance().getEffectFromEffectId(pe.id()).onUse(serverPlayer);
                            }
