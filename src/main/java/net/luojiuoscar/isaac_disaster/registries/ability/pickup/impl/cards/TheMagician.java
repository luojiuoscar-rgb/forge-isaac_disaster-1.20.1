...
public class TheMagician extends TarotAbility {
    private static final CompositeTrigger TRIGGER = new CompositeTrigger(List.of(
            new SimpleTrigger(ModTriggerTypes.EMTPY, ModExecutableEffects.THE_MAGICIAN)
    ));
    ...
    public void makeSound(ServerPlayer player) {
        ...
        player.playNotifySound(ModSounds.THE_MAGICIAN.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
    ...
    public List<Component> getDesc() {
        ...
        // 基础效果
        description.add(Component.translatable("item.isaac_disaster.the_magician.lore.1"));
        ...
        if (ClientDataManager.getInstance().getCountFromId(ItemId.TAROT_CLOTH.getId()) > 0){
            description.add(DescriptionHelper.getSynergyDesc(
                    ...
                    Component.translatable("item.isaac_disaster.the_magician.tarot_cloth.lore.1")
            ));
        }
