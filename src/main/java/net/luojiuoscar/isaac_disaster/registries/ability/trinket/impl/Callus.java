...
public class Callus extends TrinketAbility {
    public Callus(int id, int level) {
        super(id, level);
    }
    ...
    public List<Component> getDesc(@javax.annotation.Nullable ItemStack stack) {
        return List.of(
                Component.translatable("item.isaac_disaster.callus.lore.1")
        );
    }
    ...
    public List<Component> getSynergyDesc(@Nullable ItemStack stack) {
        return (stack != null && Trinket.isEnchanted(stack))
                ? List.of(Component.translatable("item.isaac_disaster.callus.lore.1")
