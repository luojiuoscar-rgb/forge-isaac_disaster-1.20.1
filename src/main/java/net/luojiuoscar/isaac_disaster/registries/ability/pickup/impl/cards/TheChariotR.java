...
public class TheChariotR extends TarotAbility {
    private static final CompositeTrigger TRIGGER = new CompositeTrigger(List.of(
            new SimpleTrigger(ModTriggerTypes.EMTPY, ModExecutableEffects.THE_CHARIOT_R)
    ));
    ...
    public void makeSound(ServerPlayer player) {
        ...
        player.playNotifySound(ModSounds.THE_CHARIOT_R.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
    }
