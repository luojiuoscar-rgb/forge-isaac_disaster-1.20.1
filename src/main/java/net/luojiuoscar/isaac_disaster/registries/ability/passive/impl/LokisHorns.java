...
import static net.luojiuoscar.isaac_disaster.registries.trigger_module.impl.normal.LokisHorns.getTriggerChance;

public class LokisHorns extends PassiveAbility {
    private static final double BASE_TRIGGER_CHANCE_PERCENT = 25.0;
    public LokisHorns(int id, int level) {
        super(id, level);
    }
    ...
    public void handleObtain(ServerPlayer player, @Nullable ItemStack stack) {
        StatManager.addTriggerModule(player, ModTriggerModule.LOKIS_HORNS.getId(), 1);
    }
    ...
    public List<Component> getDesc(@Nullable ItemStack stack, @Nullable Player player) {
        ...
        return List.of(
                Component.translatable("item.isaac_disaster.lokis_horns.lore.1",
