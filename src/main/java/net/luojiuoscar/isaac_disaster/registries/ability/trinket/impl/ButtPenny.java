...
public class ButtPenny extends TrinketAbility {
    public ButtPenny(int id, int level) {
        super(id, level);
    }
    ...
    public void onEquipped(LivingEntity entity, TrinketAbilityContext ctx) {
        StatManager.addTriggerModule(entity, ModTriggerModule.BUTT_PENNY.getId(), 1);
    }
    ...
    public List<Component> getDesc(@Nullable ItemStack stack) {
        return List.of(
                Component.translatable("item.isaac_disaster.butt_penny.lore.1")
        );
    }
