...
public class Brimstone extends PassiveAbility {
    public Brimstone(int id, int level) {
        super(id, level);
    }
    ...
    public void handleObtain(ServerPlayer player, @Nullable ItemStack stack) {
        StatManager.addAttackType(player, ModAttackType.BRIMSTONE.getId(), 1);
    }
    ...
    public List<Component> getDesc(@Nullable ItemStack stack) {
        return List.of(
                ...
                Component.translatable("item.isaac_disaster.brimstone.lore.3")
        );
    }
