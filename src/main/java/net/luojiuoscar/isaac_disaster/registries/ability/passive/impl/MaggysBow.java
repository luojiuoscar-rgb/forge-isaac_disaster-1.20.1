...
public class MaggysBow extends PassiveAbility {
    public MaggysBow(int id, int level) {
        super(id, level);
    }
    ...
    public List<Component> getDesc(@Nullable ItemStack stack, Player player) {
        return List.of(
                ...
                Component.translatable("item.isaac_disaster.maggys_bow.lore.1"),
                Component.translatable("item.isaac_disaster.maggys_bow.lore.2")
        );
    }
}
