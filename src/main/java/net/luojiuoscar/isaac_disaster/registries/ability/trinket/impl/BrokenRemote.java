...
public class BrokenRemote extends TrinketAbility {

    public BrokenRemote(int id, int level) {
        super(id, level);
    }
    ...
    public List<Component> getSynergyDesc(@Nullable ItemStack stack) {
        return (stack != null && Trinket.isEnchanted(stack))
                ? List.of(Component.translatable("item.isaac_disaster.broken_remote.enchanted.lore.1")
