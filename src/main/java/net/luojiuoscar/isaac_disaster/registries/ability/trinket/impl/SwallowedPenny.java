...
public class SwallowedPenny extends TrinketAbility {
    public SwallowedPenny(int id, int level) {
        super(id, level);
    }
    ...
    public List<Component> getSynergyDesc(@Nullable ItemStack stack) {
        return (stack != null && Trinket.isEnchanted(stack))
                ? List.of(Component.translatable("item.isaac_disaster.swallowed_penny.enchanted.lore.1")
