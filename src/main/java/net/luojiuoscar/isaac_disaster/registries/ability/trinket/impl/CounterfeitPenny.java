...
public class CounterfeitPenny extends TrinketAbility {
    public CounterfeitPenny(int id, int level) {
        super(id, level);
    }
    ...
    public List<Component> getDesc(@Nullable ItemStack stack) {
        return List.of(
                ...
                Component.translatable("item.isaac_disaster.counterfeit_penny.lore.1")
        );
    }
