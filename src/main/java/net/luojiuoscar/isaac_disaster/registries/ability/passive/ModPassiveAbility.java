...
public class ModPassiveAbility {
    ...
    public static final RegistryObject<PassiveAbility> MAGGYS_BOW =
            PASSIVE_ABILITY_REGISTRY.register("maggys_bow",
                    () -> new MaggysBow(ItemId.MAGGYS_BOW.getId(), ItemId.MAGGYS_BOW.getLevel()));
