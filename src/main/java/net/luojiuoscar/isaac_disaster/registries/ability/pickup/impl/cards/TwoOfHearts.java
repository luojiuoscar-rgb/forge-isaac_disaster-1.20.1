...
public class TwoOfHearts extends PickupAbility {
    private static final CompositeTrigger TRIGGER = new CompositeTrigger(List.of(
            new SimpleTrigger(ModTriggerTypes.EMTPY, ModExecutableEffects.TWO_OF_HEARTS)
    ));
    ...
    public void makeSound(ServerPlayer player) {
        ...
        player.playNotifySound(ModSounds.TWO_OF_HEARTS.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
    }
