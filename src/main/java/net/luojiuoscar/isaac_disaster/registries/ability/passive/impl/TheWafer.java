...
public class TheWafer extends PassiveAbility {
    public TheWafer(int id, int level) {
        super(id, level);
    }
    ...
    public void handleObtain(ServerPlayer player, @Nullable ItemStack stack) {
        StatManager.addRecursiveModule(player, ModRecursiveModule.THE_WAFER.getId(), 1);
    }
    @Override
