...
public class Venus extends PassiveAbility {
    public Venus(int id, int level) {
        super(id, level);
    }
    ...
    public void handleObtain(ServerPlayer player, @Nullable ItemStack stack) {
        ...
        StatManager.addRecursiveModule(player, ModRecursiveModule.VENUS.getId(), 1);
    }
    ...
    public List<Component> getDesc(@Nullable ItemStack stack) {
        return List.of(
            ...
            Component.translatable("item.isaac_disaster.venus.lore.1")
        );
    }
