...
public class ExecutableEffectContext {
    ...
    public ExecutableEffectContext(@NotNull LivingEntity entity) {
        this.entity = entity;
    }
    ...
    public ExecutableEffectContext copy(@Nullable LivingEntity e) {
        LivingEntity newEntity = e != null ? e : this.entity;
        ExecutableEffectContext ctx = new ExecutableEffectContext(newEntity);
