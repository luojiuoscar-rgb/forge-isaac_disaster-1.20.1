...
public class RetroVision extends PillEffect implements GiveBlackHeartIfLowQuality {
    ...
    protected boolean pillActive(ServerPlayer player, boolean isHorse, ExecutableEffectContext context) {
        player.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, isHorse ? 1500 : 600));
        return true;
    }
