...
public final class PetrifiedEffect extends FrozenEffect {
    private static final ResourceLocation SOURCE = ModVisualLayers.PETRIFIED.getId();
    ...
    public static void reconcileVisualState(LivingEntity entity) {
        FrozenEffect.reconcileVisualState(entity, ModEffects.PETRIFIED.get(), SOURCE, LAYER);
    }
}
