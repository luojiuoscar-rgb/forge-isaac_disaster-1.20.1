...
public class OuroborosWorm implements ITrinket {
    @Override
    public int getId() {
        return TrinketId.OUROBOROS_WORM.getId();
    }
    ...
    public void onEquipped(LivingEntity entity, boolean isEnchanted) {
        ...
        StatManager.addTrajectory(player, ModAttackTrajectories.OUROBOROS_WORM.getId(), 1);
        if (isEnchanted){
