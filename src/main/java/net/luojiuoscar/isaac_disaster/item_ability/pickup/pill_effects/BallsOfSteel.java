...
public class BallsOfSteel implements IPillEffect {
    ...
    public int getPillEffectId() {
        return PillEffectId.BALLS_OF_STEEL.getId();
    }
    ...
    public void onUseSound(Player player) {
        player.playSound(ModSounds.BALLS_OF_STEEL.get(), 1.0f, 1.0f);
        player.playSound(ModSounds.PILL_USE_GOOD_WITH_EFFECT.get(), 1.0f, 1.0f);
    }

    @Override
    public void onUseSoundH(Player player) {
        player.playSound(ModSounds.BALLS_OF_STEEL_H.get(), 1.0f, 1.0f);
