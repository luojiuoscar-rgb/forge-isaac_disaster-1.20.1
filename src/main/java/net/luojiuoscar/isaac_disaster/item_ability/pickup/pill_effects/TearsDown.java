...
public class TearsDown implements IPillEffect {
    @Override
    public int getPillEffectId() {
        return PillEffectId.TEARS_DOWN.getId();
    }
    ...
    public void onUseEffect(Player player) {
        ...
        StatManager.modifyTearsAdder(player, -0.4, true);
    }
    ...
    public void onUseEffectH(Player player) {
        ...
        StatManager.modifyTearsAdder(player, -0.8, true);
    }

    @Override
    public void onUseSound(Player player) {
        player.playSound(ModSounds.TEARS_DOWN.get(), 1.0f, 1.0f);
        player.playSound(ModSounds.PILL_USE_BAD.get(), 1.0f, 1.0f);
    }

    @Override
    public void onUseSoundH(Player player) {
        player.playSound(ModSounds.TEARS_DOWN_H.get(), 1.0f, 1.0f);
