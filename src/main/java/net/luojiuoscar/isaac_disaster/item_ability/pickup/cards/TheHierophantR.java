...
public class TheHierophantR implements ITarot {
    ...
    public void onUseEffect(Player player, ItemStack stack, InteractionHand hand) {
        LootHelper.spawnLootAtPos(player, player.position(), ModItems.BONE_HEART.getId(), 2);
    }

    @Override
    public void onUseEffectStronger(Player player, ItemStack stack, InteractionHand hand) {
        LootHelper.spawnLootAtPos(player, player.position(), ModItems.BONE_HEART.getId(), 3);
    }
