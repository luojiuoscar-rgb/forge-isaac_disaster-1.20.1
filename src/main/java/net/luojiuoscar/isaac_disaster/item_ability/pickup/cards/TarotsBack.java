...
public class TarotsBack implements IPickup {
    @Override
    public int getItemId() {
        return PickupId.TAROTS_BACK.getId();
    }
    ...
    public void onUseEffect(Player player, ItemStack stack, InteractionHand hand) {
        ...
        // 无源掉落
        LootHelper.spawnLootAtPos(level, player.position(), LootTableManager.RANDOM_TAROTS, params);
    }
