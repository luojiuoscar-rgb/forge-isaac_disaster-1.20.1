...
public class LemonMishap implements IActiveItem {

    @Override
    public int getItemId() {
        return ItemId.LEMON_MISHAP.getId();
    }
    ...
    public ItemStack getItemStack() {
        return new ItemStack(ModItems.LEMON_MISHAP.get());
    }

    @Override
    public List<Component> getDescription() {
        return List.of(
                Component.translatable("item.isaac_disaster.lemon_mishap.lore.1")
        );
    }
