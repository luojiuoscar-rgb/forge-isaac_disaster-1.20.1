...
3. Locked_chest: 20% to spawn an item; If it spawns any item then the original drop in it will be cleared. (tag: itemLootTable)
4. Players(not creative & spectator) within **5** blocks from a pedestal will activate it and spawns item based on its lootTables.
